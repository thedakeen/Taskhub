...
func New(log *slog.Logger, companyService companygrpc.Company, issueService companygrpc.Issue, port int) *App {
	gRPCServer := grpc.NewServer()
	companygrpc.Register(gRPCServer, companyService, issueService)
